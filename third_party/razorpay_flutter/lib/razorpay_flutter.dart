...
class Razorpay {
  ...
  void open(Map<String, dynamic> options) async {
    ...
    debugPrint('[RazorpayFlutter] Dart invoke open options=$options');
    var response = await _channel.invokeMethod('open', options);
    debugPrint('[RazorpayFlutter] Dart open response=$response');
    _handleResult(response);
  }

  /// Force closes the native checkout if it is currently visible.
  Future<void> close() async {
    debugPrint('[RazorpayFlutter] Dart invoke close');
